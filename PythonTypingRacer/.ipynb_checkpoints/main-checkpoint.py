...
pygame.display.set_caption('Hiragana Typing Race!')
...
# music and sounds
pygame.mixer.init()
pygame.mixer.music.load('D://Python/PythonTypingRacer/PythonTypingRacer/assets/sounds/music.mp3')
...
while run:
    ...
    fps_text = font2.render("FPS: {:.1f}".format(real_fps), True, 'black')
    screen.blit(fps_text, (870, 5))
